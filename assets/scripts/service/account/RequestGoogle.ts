...
const TAG = "RequestGoogle";
const PLUGIN_NAME = "PluginGoogle";

/** 请求游客登录 */
class RequestGoogle extends RequestAccount {
    ...
    public sdkLogin(callback?: (data: any) => void) {
        ...
        if (this.plugin) {
            ...
            gui.notify.show("errorcode_10008", true);
            callback(null);
        }
    }
...
RequestAccountPool.register(LoginType.google, () => {
    return new RequestGoogle();
})