...
@ccclass
export default class NoviceCallengeTask extends ComponentExtends {
    ...
    onAdded(params:any){
        ...
        this.panelAnim(nodes.get("panel"), true, true, () => {
            ...
            nodes.get("tip").getComponent(LabStepText).dataId = `beginner_5`;
            nodes.get("tip").getComponent(LabStepText).changeTo(1, () => {
                ...
                copyNode.once(cc.Node.EventType.TOUCH_END, () => {
                    ...
                    main.module.gameMainControl.openMainPop("btn_task",()=>{
                        ...
                        nodes.get("tip").getComponent(LabStepText).dataId = `beginner_6`;
                        nodes.get("tip").getComponent(LabStepText).changeTo(1, () => {
